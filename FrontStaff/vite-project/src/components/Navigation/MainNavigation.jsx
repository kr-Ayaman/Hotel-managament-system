...
const MainNavigation = props => {
  ...
  const handleBookNowClick = () => {
    console.log("Checking login status:", auth.isLoggedIn); // Debug log
    if (auth.isLoggedIn) {
